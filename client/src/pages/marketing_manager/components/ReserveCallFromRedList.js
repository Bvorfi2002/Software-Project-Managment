...
import { addReservedCallsFromRedList } from "../scripts/call-scripts";
import utc from "dayjs/plugin/utc";
import MDButton from "../../../components/MDButton";
dayjs.extend(utc);

function ReserveCallFromRedList({ chosenCalls, dependency }) {
          ...
          <ModalContent sx={style}>
            ...
            >
              ...
              <MDButton color="info" onClick={()=>{
                if(date){
                    addReservedCallsFromRedList(notification, date, chosenCalls, ()=>{
                        dependency(true);
                        handleClose();
                    });
                } else {
...
export default ReserveCallFromRedList;
