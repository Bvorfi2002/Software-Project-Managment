...
function CancelMeeting({ meeting, proceeding }) {
    ...
    const confirmationAction = ()=>{
        logMeeting(notification, proceeding, { meetingId: meeting._id, newOutcome: "Agent Cancellation"})
        handleClose();
    }
    ...
    return (
        <>
            <TriggerButton onClick={handleOpen}>
                <Icon color='secondary' fontSize='large' style={{ marginRight: "5px" }}>cancel</Icon>
                Cancel Meeting
            </TriggerButton>
            <Modal
                open={open}
            ...
            >
                <ModalContent sx={style}>
                    ...
                    <p style={{fontWeight: "normal"}}>Do you want to proceed?</p>
